...
const Homepage = () => {
  ...
  return (
    ...
    <img className=' absolute bg-contain w-full h-[500px] bg-opacity-90' src={Designer}></img>
...
<button onClick={handleClick}  className= 'text:sm ml-20 mt-4 px-2 md:mt-4  md:px-2 transition ease-in-out delay-150 bg-white hover:bg-cyan-500 text-black p-2 hover:text-white hover:-translate-y-1 hover:scale-110 duration-300  absolute rounded-lg font-bold md:ml-44 md:text-lg  shadow-2xl'> Explore Our plans </button>
                   ...
                   <div className=' mt-40  h-[900px] md:mt-56 absolute bg-gray-100 w-full md:h-[450px] '>
                     ...
                     <div className=' justify-items-start md:flex md:justify-between mt-12 ml-4 overflow-x-hidden'>
                       <div className=' col-2 px-3'>
                         <img className=' w-32 h-28 ml-8' src={efficiency} />
                       ...
                       <div className='col-2 px-3'>
                         <img className='w-32 h-28  ml-8' src={sustainable} />
                         <h4 className='font-bold text-center ml-4'> Sustainable</h4>
                         <p className='text-sm text-center ml-8'> Contribute to a greener planet with intelligent energy management.</p>

                       </div>
                       <div className='col-2 px-3 '>
                         <img className='w-32 h-28  mr-6' src={convenience} />
                         <h4 className='font-bold text-center mr-4'>Convenience</h4>
                         <p className='text-sm text-center mr-4'>Enjoy a fully automated system that requires minimal intervention.</p>

                       </div>
                       <div className=' col-2 px-3'>
                         <img className='w-32 h-28   mr-6' src={savings} />
                         <h4 className='font-bold text-center mr-16'>Cost Saving</h4>
                         <p className='text-sm text-center mr-10'>Reduce your energy costs by upto 60%</p>

                       </div>

                     </div>

                   </div><SUSNET /><SusnetComponent /><SusnetKits /><Plans /><QuizSection />
                 </>
